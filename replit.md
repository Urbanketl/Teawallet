...
## Recent Changes
- July 31, 2025: COMPLETED - Professional login page redesign with sophisticated slate-blue-indigo gradient, actual UrbanKetl logo integration, and enhanced feature cards with colored icons
...
- July 29, 2025: Changed /api/machines/:machineId/tea-prices to /api/machines/:machineId/tea-price returning single Regular Tea price
- July 29, 2025: Updated TEA_PRICING_CONTROL_GUIDE.md and API_Testing_Guide.md to reflect simplified pricing system
...
- July 29, 2025: COMPLETED - Added missing RFID card activation functionality with new API endpoint and storage methods for reactivating inactive cards
- July 29, 2025: COMPLETED - Removed RFID Card component from dashboard - RFID cards now managed exclusively in Business Unit section under Employee Cards tab
